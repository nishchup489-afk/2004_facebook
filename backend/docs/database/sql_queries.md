...
University email generated

    ↓

One-time registration code generated
...
Thefacebook Registration

email + name + university + registration code

    ↓

FastAPI finds student
